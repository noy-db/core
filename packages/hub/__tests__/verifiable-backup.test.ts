...
describe('verifiable backups.', () => {
  ...
  it('rejects a backup whose embedded ledgerHead.hash was modified', async () => {
    ...
    // source of an intermittent CI flake until  fixed it.
  ...
  //  — DictionaryHandle ledger entries used to write
