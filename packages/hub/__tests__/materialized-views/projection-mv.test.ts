...
/** The pilot1-shaped 5-leg projection: 1 forward (client) + 4 collect legs. */
...
/** Open a vault with the pilot1-shaped collections + refs declared. */
async function openBillsVault(mv = billRowsMV(), secret = 'mv-projection-pilot1-secret-2026') {
...
describe('projection MV (#810) — pilot1-shaped acceptance', () => {
