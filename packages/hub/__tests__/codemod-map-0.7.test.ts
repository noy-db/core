...
describe('codemods/0.7.0-pre.json — satellite rows', () => {
  ...
  const EXTRACTED = new Map([
    ['@noy-db/as-csv', 'noy-db/as'],
    ['@noy-db/as-json', 'noy-db/as'],
    ['@noy-db/as-sql', 'noy-db/as'],
    ['@noy-db/as-xml', 'noy-db/as'],
    ['@noy-db/at-aws-kms', 'noy-db/at'],
    ['@noy-db/at-azure-keyvault', 'noy-db/at'],
    ['@noy-db/at-env', 'noy-db/at'],
    ['@noy-db/at-gcp-kms', 'noy-db/at'],
    ['@noy-db/at-macos-keychain', 'noy-db/at'],
