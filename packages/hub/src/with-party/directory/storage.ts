 ...
 *
 * @see https://github.com/noy-db/docs/blob/main/content/docs/services/user-envelope.md → Directory visibility
 * @see https://github.com/noy-db/docs/blob/main/content/docs/services/plaintext-bypass.md — every `_iv: ''` write site
 *
 * @module
 */
