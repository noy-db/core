...
[![license](https://img.shields.io/npm/l/@noy-db/hub.svg)](https://github.com/noy-db/core/blob/main/LICENSE)

Part of [**noy-db**](https://github.com/noy-db/core) — *"None Of Your Damn Business"*. This is the **core library** — install this first, then pair it with a storage backend.
...
- Full docs: <https://github.com/noy-db/docs>
- Spec: <https://github.com/noy-db/docs/blob/main/SPEC.md>
- Roadmap: <https://github.com/noy-db/docs/blob/main/ROADMAP.md>
