...
`ConflictError` from a `409` — lives in the [`noy-db-to`](https://github.com/noy-db/to)
...
- Source — [`packages/in-rest`](https://github.com/noy-db/core/tree/main/packages/in-rest)
