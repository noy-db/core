...
A Vite + Vue 3 + Pinia + [noy-db](https://github.com/noy-db/core)
...
- [noy-db getting started](https://github.com/noy-db/core/blob/main/docs/choose-your-path.md)
- [Topology matrix](https://github.com/noy-db/core/blob/main/docs/topologies.md)
