...
Wizard + CLI tool for [noy-db](https://github.com/noy-db/core) — scaffold a fresh Nuxt 4 + Pinia encrypted store, augment an existing Nuxt project, or run operational commands (add user, rotate keys, backup) from the command line.
...
- **Thai i18n** of the wizard prompts ([#36](https://github.com/noy-db/core/issues/36))
